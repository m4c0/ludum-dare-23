...
public class OxygenTutorial3 : MonoBehaviour {
	...
	public void OnGUI() {
		...
		_Alphalulu(4);
		GUI.Label(new Rect(100, 150, 300, 50), "If you are a regular human being, 60% of your body is made of water.");

		_Alphalulu(9);
		GUI.Label(new Rect(100, 200, 300, 50), "Anything below that means you really need to seek medical attention.");
	}
